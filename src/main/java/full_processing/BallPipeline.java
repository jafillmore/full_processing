...
public class BallPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double blurRadius = 3.773585805353124;
		...
		int cvDilateBordertype = Core.BORDER_REFLECT;
		Scalar cvDilateBordervalue = new Scalar(-1);
		cvDilate(cvDilateSrc, cvDilateKernel, cvDilateAnchor, cvDilateIterations, cvDilateBordertype, cvDilateBordervalue, cvDilateOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = cvDilateOutput;
		double[] hsvThresholdHue = {27.11864487599518, 52.94118136645638};
		double[] hsvThresholdSaturation = {0.0, 225.90908397327772};
		double[] hsvThresholdValue = {195.93219629115302, 255.0};
		...
		double[] filterContoursSolidity = {92.44603647602547, 100.0};
		double filterContoursMaxVertices = 1000000.0;
		double filterContoursMinVertices = 0.0;
		double filterContoursMinRatio = 0.7;
		double filterContoursMaxRatio = 2.3;
