...
public class TargetPipeline implements VisionPipeline {
	...
	public int contourloop = 0;
	public int filterloop = 0;
	public int foundContours = 0;
	public int foundTargets = 0;
	...
	@Override	public void process(Mat source0) {
		...
		double filterContoursMaxHeight = 180.0;
		double[] filterContoursSolidity = {11.0, 35.0};
		double filterContoursMaxVertices = 1500.0;
		...
		foundContours = findContoursOutput().size();
		foundTargets = filterContoursOutput().size();
	}
